...
AppMobi.OAuthInternal = function() {
	...
	this.oAuthServerOrigin = "https://services.html5tools-software.intel.com";
...
script.setAttribute('src', 'https://services.html5tools-software.intel.com/external/echoip.aspx?callback=setAnalyticsIP');
head.appendChild(script);
...
document.dispatchEvent = function(e) {
	...
	if(e.type.indexOf('appMobi.') == 0) {
		...
		//shallow copy should be good enough for appMobi.* events
		for(var prop in e) {
